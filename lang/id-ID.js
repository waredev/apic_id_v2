export default {
    ...
    submenu: {
        ...
        company_profile: {
            ...
            sub: {
                company_information: 'INFORMASI PERUSAHAAN DAN ENTITAS ANAK',
                ...
                visi_and_mission: 'VISI DAN MISI',
            }
        },
        corporate_governance: {
            title: 'TATA KELOLA PERUSAHAAN',
            sub: {
                guidlines_commissioners: 'PEDOMAN KERJA KOMISARIS DAN DIREKSI',
                audit_commite: 'PIAGAM AUDIT',
                code_of_conduct: 'KODE ETIK',
                risk_manajement: 'MANAJEMEN RISIKO'
            }
        },
        disclosure_information: {
            title: 'INFORMASI KETERBUKAAN LAINNYA',
            sub: {
                audit_commite_information: 'INFORMASI KOMITE AUDIT',
    ...
    home: {
        ...
        about_title: 'Tentang Pacific Strategic Financial Tbk',
    ...
    about: {
        ...
        vision_label: 'VISI',
        mision_label: 'MISI',
        vision_content: 'Menjadi perusahaan investasi termuka di Indonesia yang bersandarkan pada 5 pilar yaitu kejujuran, ketekunan, pelayanan, pengalaman dan disiplin.',
        mision_content: {
            mission_content1: 'Mengembangkan aset dan sumber daya manusia yang ada secara berkelanjutan.',
