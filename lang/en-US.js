export default {
    ...
    about: {
        ...
        supporting_professional_institutions: 'Supporting Professional Institutions',
        award_label: 'Awards',
        work_guidelines: 'Work Guidelines for the Commissioners and Directors',
        audit_commite_label: 'Audit Committee',
        code_of_conduct: 'Code of Conduct',
        risk_manajement: 'Risk Management',
        information_committee_audit_label: 'Information on Audit Committees',
        corporate_social_responsibility_label: 'Corporate Social Responsibility'
    },
    gcg: {
        annual_report: 'Annual Report',
        rups: 'GMS',
