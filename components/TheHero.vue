<template>
    <div class="h-screen relative bg-light-blue bg-hero bg-cover">
      ...
      <div class="xl:px-32 px-8 xl:pt-96 pt-40 font-arian-bold relative z-10">
      ...
      <img src="~/assets/images/hero-hand.png" class="xl:flex object-contain absolute right-0 z-0 bottom-0 2xl:w-[58.813rem] md:w-[35rem]">
    </div>
  </template>
